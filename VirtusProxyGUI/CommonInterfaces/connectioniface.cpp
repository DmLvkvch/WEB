...
ConnectionIFace::ConnectionIFace(QString _name, QList<SettingsItem> _settings)
{
    ...
    QObject::connect(this, &ConnectionIFace::connectionStatusChanged, this, &ConnectionIFace::handleSetStatus);
}
...
void ConnectionIFace::handleSetStatus(Status _status){
...
void ConnectionIFace::setSettings(const QList<SettingsItem> & _settings)
{
    this->_settings = _settings;
}
